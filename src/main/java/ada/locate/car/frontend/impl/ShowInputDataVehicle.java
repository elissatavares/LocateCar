...
public class ShowInputDataVehicle implements Input<String[]> {
    @Override
    public String[] execute() {
        String title = MessagesVehicle.DESCRIPTION_INSERT_DATA.get();
        String fields = MessagesVehicle.DESCRIPTION_ALL_DATA.get();
