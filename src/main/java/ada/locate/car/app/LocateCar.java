...
//        ReadAllClientsService readAllClientsService = new ReadAllClientsService(clientRepository);
...
//        Controller readAllClients = new ListAllClientsControllerImpl(showInformation, readAllClientsService);
...
//        Menu clientMenu = new ClientMenu(inputOptionString, createClientCPF, createClientCNPJ, readAllClients);
        ...
        Menu clientMenu = new ClientMenu(inputOptionString, showInformation, createClient);
